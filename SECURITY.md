...
The following versions of **TypeSpeakPro** are currently supported with security updates:
...
To report a security vulnerability in **TypeSpeakPro**, please reach out via:

- 👤 Maintainer: [SufalBasak](https://github.com/SufalBasak)
...
- [TypeSpeakPro Repository](https://github.com/SufalBasak/TypeSpeakPro)
